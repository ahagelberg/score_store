...
MAESTRO_KEY_BACKUP_SCHEDULE = "backup_schedule"
MAESTRO_KEY_BACKUP_LAST_SCHEDULED = "backup_last_scheduled"
BACKUP_SCHEDULE_DAILY = "daily"
BACKUP_SCHEDULE_WEEKLY = "weekly"
BACKUP_SCHEDULE_MONTHLY = "monthly"
BACKUP_SCHEDULE_VALUES = frozenset({
    BACKUP_SCHEDULE_DAILY,
    BACKUP_SCHEDULE_WEEKLY,
    BACKUP_SCHEDULE_MONTHLY,
})
DEFAULT_BACKUP_SCHEDULE = BACKUP_SCHEDULE_WEEKLY
...
BACKUP_SCHEDULE_MINUTE = 40
BACKUP_SCHEDULER_LOCK_FILENAME = "backup_scheduler.lock"
BACKUP_SCHEDULER_WAKE_INTERVAL_SEC = 60
BACKUP_SCHEDULE_WEEKLY_MIN_DAYS = 7
